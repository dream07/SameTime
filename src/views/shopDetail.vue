<template>
    <div class="content edit">
        ...
        <h2 class="editfoodrecordTit">店铺详情</h2>
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <div style="margin: -35px 0 10px 100px;color: red;">请通过地图选点来选择店铺精确位置，点击锚点以导入经纬度度</div>
            <el-form-item label="所在区域:">
                <div class="flexBox">
                    ...
                    <el-form-item label-width="0px" prop="area" style="width: 30%;">
                        <el-select v-model="ruleForm.area" @change="choseBlock" placeholder="区级地区" style="width: 100%;" disabled>
            ...
            <el-form-item label="精度:" prop="lon" style="width: 100%;">
                <el-input v-model="ruleForm.lon	" placeholder="精度" disabled></el-input>
            </el-form-item>
            <el-form-item label="纬度:" prop="lat" style="width: 100%;">
                <el-input v-model="ruleForm.lat" placeholder="纬度" disabled></el-input>
            </el-form-item>
            <el-form-item label="详细地址:" prop="address">
                <el-input v-model="ruleForm.address" placeholder="请输入详细地址" disabled></el-input>
            </el-form-item>
            ...
            <div class="flexBox">
                <el-form-item label="营业时间:" prop="dateTime" style="width: 50%;">
                    <el-time-picker is-range v-model="ruleForm.dateTime" range-separator="至" start-placeholder="开始时间"
                        ...
                        value-format="HH:mm" disabled>
                    </el-time-picker>
                </el-form-item>
                <el-form-item label="人均消费:" prop="avg" style="width: 50%;">
                    <el-input v-model="ruleForm.avg" placeholder="请输入人均消费" disabled></el-input>
                </el-form-item>
            </div>
            <div class="flexBox">
                <el-form-item label="最低消费:" prop="low" style="width: 50%;">
                    <el-input v-model="ruleForm.low" placeholder="请输入最低消费" disabled></el-input>
                </el-form-item>
                <el-form-item label="联系人:" prop="realname" style="width: 50%;">
                    <el-input v-model="ruleForm.realname" placeholder="请输入联系人" disabled></el-input>
                </el-form-item>
            </div>
            <div class="flexBox">
                ...
                <el-form-item label="营业期限:" prop="licenseendtime" style="width: 50%;">
                    <el-date-picker v-model="ruleForm.licenseendtime" style="width: 100%;" type="date"
                        placehostlder="请输入营业期限" value-format="yyyy-MM-dd" disabled>
                    </el-date-picker>
                </el-form-item>
            </div>
            <div class="flexBox">
            ...
            <el-form-item label="电话:" prop="tel" style="width: 50%;">
                <el-input v-model="ruleForm.tel" placeholder="请输入您的电话" disabled></el-input>
            </el-form-item>
            <el-form-item label="店铺状态:">
                <el-switch v-model="ruleForm.type" :active-value="1" :inactive-value="0" disabled></el-switch>
            </el-form-item>
            <div class="flexBox">
                <el-form-item label="营业执照:">
                    <el-upload class="avatar-uploader" action="https://store.galaxyhigh.cn/store/server/upDataImg" :show-file-list="false"
                        :on-success="handleAvatarSuccess1" :limit="1" :multiple="true" disabled>
                ...
                <el-form-item label="店铺logo:">
                    <el-upload class="avatar-uploader" action="https://store.galaxyhigh.cn/store/server/upDataImg" :show-file-list="false"
                        :on-success="handleAvatarSuccess2" :limit="1" :multiple="true" disabled>
                ...
                <el-form-item label="卫生许可证:">
                    <el-upload class="avatar-uploader" action="https://store.galaxyhigh.cn/store/server/upDataImg" :show-file-list="false"
                        :on-success="handleAvatarSuccess3" :limit="1" :multiple="true" disabled>
            ...
            <div class="shenfenzheng">
                <el-form-item label="身份证正面:">
                    <el-upload class="avatar-uploader" action="https://store.galaxyhigh.cn/store/server/upDataImg" :show-file-list="false"
                        :on-success="handleAvatarSuccess4" disabled>
                ...
                <el-form-item label="身份证反面:" style="margin-left: 80px;">
                    <el-upload class="avatar-uploader" action="https://store.galaxyhigh.cn/store/server/upDataImg" :show-file-list="false"
                        :on-success="handleAvatarSuccess5" disabled>
            ...
            <el-form-item label="店铺图片:">
                <el-upload action="https://store.galaxyhigh.cn/store/server/upDataImg" list-type="picture-card"
                    ...
                    :limit="5" :multiple="true" :file-list='filelist' :on-exceed="onexceed" disabled>
                    ...
                    <el-table-column label="状态:" align="center">
                        <template slot-scope="scope">
                            <el-switch v-model="scope.row.enable" :active-value="1" :inactive-value="0"
                                @change="enableChange(scope.row.id)" disabled></el-switch>
                        </template>
                    </el-table-column>
                    <!-- <el-table-column label="操作:" align="center">
                        <template slot-scope="scope">
