<template>
  <div>
    ...
    <el-table border :data="tableData" style="width: 100%">
      ...
      <el-table-column sortable prop="odd" label="订单号">
      </el-table-column>
      ...
      <el-table-column prop="date" label="下单时间" sortable
      ...
      <el-table-column prop="tag" label="订单分类" width="150"
        :filters="[{ text: '虚拟', value: '虚拟' }, { text: '实物', value: '实物' }]" :filter-method="filterTag"
        filter-placement="bottom-end">
        <template slot-scope="scope">
          <el-tag :type="scope.row.tag === '虚拟' ? 'primary' : 'success'" disable-transitions>{{scope.row.tag}}</el-tag>
        </template>
      </el-table-column>
