<template>
    <div class="editfoodrecord">
        ...
        <el-dialog title="选择周期" :visible.sync="checkdata" width="30.5%" :before-close="handleClose">
        ...
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px" class="demo-ruleForm">
            <el-form-item label="促销特价" prop="tejia">
                <el-input v-model="ruleForm.tejia" placeholder="请输入促销特价" @input="tejiaChange" disabled></el-input>
            </el-form-item>
            ...
            <el-form-item label="促销时间" prop="value2">
                <el-date-picker v-model="ruleForm.value2" type="daterange" align="right" unlink-panels
                    ...
                    :picker-options="houPickerOptions" style="width: 100%;" @change="onPick" disabled>
                </el-date-picker>
            </el-form-item>
            <el-form-item label="促销周期" prop="checkList">
                <el-button icon="el-icon-time" @click="checkdataTan">选择周期</el-button>
            </el-form-item>
                    ...
                    <el-table-column label="状态" align="center">
                        <template slot-scope="scope">
                            <el-switch v-model="scope.row.type" :active-value="1" :inactive-value="0"
                                @change="switchChange(scope.row.zkid)" disabled></el-switch>
                        </template>
                    </el-table-column>
                </el-table>
            </el-form-item>
            ...
            <!-- <el-form-item style="margin-top: 30px;">
                ...
                <el-button @click='cancelSure=true'>取消</el-button>
            </el-form-item> -->
        </el-form>
    </div>
</template>
            ...
            return {
                ...
                rules: {
                    tejia: [
                        ...
                        { pattern: /^[0-9]+([.][0-9]{1}){0,1}$/, message: '只能输入数字且保留小数点后一位', trigger: 'blur' },
                    ],
                    zhekou: [
