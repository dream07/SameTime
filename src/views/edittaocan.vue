<template>
    <div class="editfoodrecord">
        ...
        <h2 class="editfoodrecordTit">编辑套餐</h2>
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="特价:" prop="price">
                <el-input v-model="ruleForm.price" placeholder="选择菜品将自动生成"></el-input>
            </el-form-item>
            ...
            <el-form-item label="商品状态:">
                <el-switch v-model="ruleForm.enable" :active-value="1" :inactive-value="0"></el-switch>
            </el-form-item>
            ...
            <el-form-item label="预览图:">
                <el-upload action="https://store.galaxyhigh.cn/store/server/upDataImg" list-type="picture-card"
                    ...
                    :on-success="handleSuccess" :limit="1" :multiple="true">
    ...
    export default {
        ...
        created() {
            ...
            this.$axios.post('/store/Promotion/getTaocanForm', {
                ...
                this.ruleForm.banner_img = response.data.info.banner_img
